 ...
 */
public class ExtendedJdbcMutableAclService extends JdbcAclService implements MutableAclService {
    //~ Instance fields ================================================================================================
    ...
    public ExtendedJdbcMutableAclService(DataSource dataSource, LookupStrategy lookupStrategy, AclCache aclCache) {
    ...
    /**
     * Creates an entry in the acl_object_identity table for the passed ObjectIdentity. The Sid is also necessary, as
     * acl_object_identity has defined the sid column as non-null.
     *
    ...
    /**
     * Retrieves the primary key from {@code acl_class}, creating a new row if needed and the {@code allowCreate}
    ...
    /**
     * Retrieves the primary key from the acl_object_identity table for the passed ObjectIdentity. Unlike some other
     * methods in this implementation, this method will NOT create a row (use {@link
    ...
    /**
     * This implementation will simply delete all ACEs in the database and recreate them on each invocation of this
     * method. A more comprehensive implementation might use dirty state checking, or more likely use ORM capabilities
     * for create, update and delete operations of {@link MutableAcl}.
     */
    ...
    /**
     * Updates an existing acl_object_identity row, with new information presented in the passed MutableAcl object. Also
     * will create an acl_sid entry if needed for the Sid that owns the MutableAcl.
     *
    ...
    /**
     * Sets the query that will be used to retrieve the identity of a newly created row in the <tt>acl_sid</tt> table.
     *
    ...
    /**
     * @param foreignKeysInDatabase if false this class will perform additional FK constrain checking, which may cause
     *                              deadlocks (the default is true, so deadlocks are avoided but the database is
     *                              expected to enforce FKs)
     */
