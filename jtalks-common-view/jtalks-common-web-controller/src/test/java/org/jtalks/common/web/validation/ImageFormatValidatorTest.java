...
public class ImageFormatValidatorTest {
    ...
    public void testValidatorSuccess(String contentType) {
        Set<ConstraintViolation<TestObject>> constraintViolations = validator.validate(new TestObject(
            new MockMultipartFile("test_avatar", "test_avatar", contentType, new byte[10])));
    ...
    public Object[][] allowableFormats() {
        return new Object[][]{{ImageFormats.JPG.getContentType()}, {ImageFormats.PNG.getContentType()}, {ImageFormats
            .GIF.getContentType()}};
    }

    @DataProvider
    public Object[][] notAllowableFormats() {
        return new Object[][]{{"image/bmp"}, {"image/tiff"}, {"text/plain"}, {"audio/mpeg"}, {"audio/x-wav"}, {"text/plain"}, {"text/html"}, {"video/mpeg"}
