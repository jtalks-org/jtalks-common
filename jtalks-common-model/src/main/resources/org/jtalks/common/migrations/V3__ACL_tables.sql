...
CREATE TABLE `acl_entry` (
  ...
  `granting` tinyint(1) NOT NULL,                                 -- a value, that identifies whether the permission is allowed or not (for JCommune - 1 - allowed, 0 - not allowed)
...
--
-- Each table entry is the representation of the object. for which the permissions are given
--
...
CREATE TABLE `acl_object_identity` (
  ...
  `owner_sid` bigint(20) DEFAULT NULL,                                -- a link to a acl_sid table - the owner of the object
